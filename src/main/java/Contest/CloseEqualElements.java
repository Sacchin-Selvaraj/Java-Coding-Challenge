...
public class CloseEqualElements {
    ...
    public static HashMap<Integer, ArrayList<Integer>> buildMap(int[] nums, int n) {
    ...
    public static int solve(ArrayList<Integer> l, int q, int n) {
    ...
    public static int binarySearch(ArrayList<Integer> l, int target) {
